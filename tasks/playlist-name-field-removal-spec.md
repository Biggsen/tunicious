...
**Functional Tests:**
- [ ] Create new playlist (should not require name field)
- [ ] Edit playlist (should not show name field)
- [ ] View playlists (should show Spotify names)
- [ ] View single playlist (should show Spotify name)
- [ ] Homepage movements (should show correct playlist names)
- [ ] Edit playlist dropdowns (should show correct playlist names)
- [ ] Album history (should store only playlistId)
- [ ] Move album between playlists (should work correctly)
- [ ] Pipeline generation (should create playlists without name field)

**Performance Tests:**
- [ ] Verify no excessive API calls when resolving names
- [ ] Verify cache is being used effectively
- [ ] Verify batch resolution works for multiple playlists

**Edge Cases:**
- [ ] Playlist not found in cache (should fetch from API)
- [ ] Playlist deleted from Spotify (should handle gracefully)
- [ ] Network error when fetching name (should show fallback)
- [ ] Old album history entries (should still work with playlistId only)
