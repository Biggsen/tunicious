...
export function useLastFmUsageStats() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      const todayDocRef = collection(db, 'lastfmUsageHourly');
      ...
      const usageRef = collection(db, 'lastfmUsage');
      ...
      const weekDocRef = collection(db, 'lastfmUsageDaily');
      ...
      console.error('Error fetching Last.fm usage stats:', err);
    } finally {
      loading.value = false;
    }
  };
